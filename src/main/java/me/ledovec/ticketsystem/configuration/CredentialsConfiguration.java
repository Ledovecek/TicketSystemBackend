...
@EnableJpaRepositories(
        basePackages = "me.ledovec.ticketsystem.repositories.credentials",
...
public class CredentialsConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean credentialsEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "me.ledovec.ticketsystem.entities.credentials" });
    ...
    @Primary
    @Bean
    public DriverManagerDataSource credentialsDataSource() {

        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName("org.mariadb.jdbc.Driver");
        dataSource.setUrl("jdbc:mariadb://localhost:3306/authme");
